...
public class Client {
    public static void main(String[] args) throws IOException {
        ...
        if (args.length != 2) {
            ...
            System.out.println("host name is server IP address (e.g. 127.0.0.1) ");
            System.out.println("port is a positive number in the range 1025 to 65535\n");
            System.exit(1);
        }
        ...
        try {
            ...
            System.err.println("the socket could not be opened, or the socket could not bind to the specific port " +
                    portNumber);
            System.exit(1);
        }
